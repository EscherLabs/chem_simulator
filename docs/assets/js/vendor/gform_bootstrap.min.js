var gform = function(optionsIn, el){
    ...
    this.listener = function(e){
        ...
        if(e.target.classList.value.indexOf('gform-')<0 && e.target.parentElement !== null && e.target.parentElement.classList.value.indexOf('gform-')>=0){
...
gform.layout = function(field){
    ...
    if('parent' in field && !!field.parent.container){
        ...
        if(field.target instanceof Element || field.target instanceof HTMLDocument){
            // var temp = field.owner.el.querySelector(field.target);
            // if(typeof temp !== 'undefined' && temp !== null){
                search ={target:field.target};
